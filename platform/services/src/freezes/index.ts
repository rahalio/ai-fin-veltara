/**
 * Freezes Services - Application Layer Export
 *
...
/**
 * Freezes Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for freezes domain.
 */
